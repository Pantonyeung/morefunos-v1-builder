...
requireAll(carrier, [
  ...
  'npm --prefix apps/smt-clean install --workspaces=false --package-lock=false --ignore-scripts --no-audit --no-fund',
  'carrier-smt-clean-production-contract',
  'production-runtime-contract.test.ts',
  'carrier-smt-clean-build',
  'npm --prefix apps/smt-clean run build --workspaces=false',
