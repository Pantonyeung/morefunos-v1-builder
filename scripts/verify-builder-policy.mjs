...
requireAll(carrier, [
  ...
  'carrier-web-compat',
  'npm --prefix apps/smt-web test',
  'carrier-smt-clean-install',
  "cd apps/smt-clean && npx -y npm@12.0.2 install --workspaces=false --package-lock=false --ignore-scripts --no-audit --no-fund",
  'carrier-smt-clean-production-contract',
  'production-runtime-contract.test.ts',
  "cd apps/smt-clean && npx -y npm@12.0.2 exec -- vitest run src/runtime/production-runtime-contract.test.ts",
  'carrier-smt-clean-build',
  "cd apps/smt-clean && npx -y npm@12.0.2 run build --workspaces=false",
  'carrier-smt-clean-installed-asset-base',
  'carrier-static',
